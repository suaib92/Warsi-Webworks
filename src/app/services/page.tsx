...
const services = [
  {
    ...
    slug: "website-development-moradabad",
  },
  {
    id: "02",
    ...
    slug: "ecommerce-development-moradabad",
  },
  {
    id: "03",
    title: "React Development",
    desc: "Complex web applications built on modern React stack. Real-time data, complex state management, and custom APIs.",
    features: ["React + Redux/Zustand", "REST & GraphQL APIs", "Real-time data with WebSockets", "Cloud deployment"],
    slug: "react-development-moradabad",
  },
  {
    id: "04",
    title: "Next.js Development",
    desc: "The modern web's fastest framework. We build hyper-fast, SEO-friendly applications that dominate organic search.",
    features: ["Server-Side Rendering (SSR)", "App Router & Server Components", "Automatic Optimization", "Vercel deployment"],
    slug: "nextjs-development-moradabad",
  },
  {
    id: "05",
    ...
    slug: "mobile-app-development-moradabad",
  },
  {
    id: "06",
    title: "SEO Services",
